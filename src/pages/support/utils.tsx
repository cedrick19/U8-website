...
export const support: SupportDataType[] = [
  {
    id: 1,
...
export const SupportComponentArray: SegmentButtons[] = [
  {
    tabName: 'All',
    component: <SupportComponent data={support} />,
  },
  {
    tabName: 'Newcomer Exclusive',
    component: <SupportComponent data={support.filter((n) => n.type === 'newcomer')} />,
  },
  {
    tabName: 'System',
    component: <SupportComponent data={support.filter((n) => n.type === 'system')} />,
  },
  {
    tabName: 'Events',
    component: <SupportComponent data={support.filter((n) => n.type === 'events')} />,
  },
];
